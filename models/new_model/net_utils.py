...
class CrossAttention(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        # B num_heads C//num_heads C//num_heads
...
if __name__ == '__main__':
    model = FeatureFusionModule(256, num_heads=8).cuda()
    left = torch.randn(1, 256, 256, 256).cuda()
    right = torch.randn(1, 256, 256, 256).cuda()
