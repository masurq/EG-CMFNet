...
# 训练设置
C.train_batch_size =16# 32
C.in_channel1 = 3
C.in_channel2 = 1
C.use_amp = False
C.backbone ='biformer-tiny'
C.pretrained_model ='pre_trained/biformer/biformer_tiny_best.pth'#'/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/pre_trained/transunet/R50+ViT-B_16.npz'#'/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/pre_trained/biformer/biformer_tiny_best.pth'#'/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/pre_trained/RMT/RMT-S.pth'  # '/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/pre_trained/biformer/biformer_tiny_best.pth'  #"/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/pre_trained/segformers/mit_b2.pth"
...
C.norm_mean = [0.24162810912747584,
0.23903183493105973,
0.2278617560439795 ],
C.norm_std =   [0.11778970982202897,
0.11954561171321171,
0.12869108470067891]
C.norm_mean_X = [0.25895214464256483]
C.norm_std_X = [0.19383291507598127 ]
...
# dataset设置
C.dataset_name = 'sixx'
C.train_data_root = r'run_data/DDHR_shangdong/train'
C.val_data_root = r'run_data/DDHR_shangdong/val'
C.test_data_root = r'run_data/DDHR_shangdong/test'
